...
class MediaAtomMaker(context: Context)
  ...
  private val plutoCommission = new PlutoCommissionController(hmacAuthActions, stores)
  private val plutoProject = new PlutoProjectController(hmacAuthActions, stores)
